...
public final class PoseCatalog {
    ...
    private final List<Pose> poses = List.of(
            ...
            pose("chair", "Chair", 40, "Sit your hips back as if reaching for a chair.", "Reduce the depth or touch a chair behind you.", List.of(knee("chair-knee", 85, 135, "Try a smaller knee bend and keep your knees tracking toward your toes."))),
            pose("warrior_one", "Warrior I", 45, "Step one foot back and lift through your chest.", "Shorten your stance and keep hands at hips.", List.of(knee("front-knee", 80, 125, "Try bending your front knee gently toward your toes."))),
            pose("warrior_two", "Warrior II", 50, "Open your hips and arms while looking over the front hand.", "Shorten your stance if this feels uncomfortable.", List.of(knee("front-knee", 80, 120, "Move your front knee slightly toward your toes."))),
            ...
            pose("low_lunge", "Low Lunge", 50, "Step one foot forward and let your hips ease ahead.", "Pad the back knee and keep hands on blocks or thigh.", List.of(knee("front-knee", 75, 120, "Try stacking your front knee more comfortably over your ankle."))),
