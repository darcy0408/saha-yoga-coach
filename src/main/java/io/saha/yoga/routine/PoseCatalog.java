...
public final class PoseCatalog {
    ...
    private static List<Pose> buildPoses() { return List.of(
            ...
            pose("upward_salute", "Upward Salute", 35, "Sweep both arms overhead and lengthen from your hips.", "Take the arms shoulder-width apart, or stop at shoulder height.",
                    List.of(arm("reaching-arm", BilateralStrategy.STRAIGHTEST, 130, 180, "Try lengthening through your elbow as you reach up."))),
    ...
    private static AlignmentRule knee(String id, BilateralStrategy strategy, double min, double max, String cue) {
        return new AlignmentRule(id, LandmarkName.LEFT_HIP, LandmarkName.LEFT_KNEE, LandmarkName.LEFT_ANKLE, strategy, min, max, cue, 1, true);
    }
    ...
    private static AlignmentRule arm(String id, BilateralStrategy strategy, double min, double max, String cue) {
        return new AlignmentRule(id, LandmarkName.LEFT_SHOULDER, LandmarkName.LEFT_ELBOW, LandmarkName.LEFT_WRIST, strategy, min, max, cue, 2, true);
    }
