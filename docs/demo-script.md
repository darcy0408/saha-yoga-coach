...
| 0:30–1:00 | Coaching | Start **Steady Start**. "Each pose shows structured instructions, at most two supportive cues, and a live confidence value. When confidence drops below the gate —" (wait for the injected low-confidence frame) "— corrections stop and the timer pauses instead of guessing." |
